...
import br.com.okeaa.apiokeaapdv.controllers.request.contato.*;
...
import br.com.okeaa.apiokeaapdv.exceptions.contato.DetalhesErroResponse;
import br.com.okeaa.apiokeaapdv.exceptions.contato.ErroResponse;
...
class ContatoControllerTest {
    ...
    void testGetAllContacts() {
        ...
        // CONTATO TESTE 01
        RetornoResponseContato.Contatos contato1 = new RetornoResponseContato.Contatos();
...
//        contato1.contato.setCpf_cnpj("000.000.000-00");
        ...
        // CONTATO TESTE 02
        RetornoResponseContato.Contatos contato2 = new RetornoResponseContato.Contatos();
...
//        contato2.contato.setCpf_cnpj("000.000.000-00");
        ...
        RetornoResponseContato retorno = new RetornoResponseContato();
        retorno.contatos = new ArrayList<>();
        retorno.contatos.add(contato1);
        retorno.contatos.add(contato2);

        JsonResponseContato resposta = new JsonResponseContato();
        ...
        JsonResponseContato result = contatoController.getAllContacts().getBody();
    ...
    void testGetContactsById() {
        ...
        ArrayList<RetornoResponseContato.Contatos> contatos = new ArrayList<>();
...
//        contato.contato.setCpf_cnpj("000.000.000-00");
        ...
        JsonResponseContato result = contatoController.getContactsById(idContato).getBody();
        assertEquals(resposta, result);
    ...
    void testCreateContact() {
        ...
        JsonRequestContato resposta = new JsonRequestContato();
        RetornoRequestContato retorno = new RetornoRequestContato();

        ArrayList<ArrayList<RetornoRequestContato.Contatos>> contatos = new ArrayList<>();
        ArrayList<RetornoRequestContato.Contatos> contatosList = new ArrayList<>();
        RetornoRequestContato.Contatos contato = new RetornoRequestContato.Contatos();
...
//        contato.contato.setCnpj("00.000.000/0000-00");
        ...
        JsonRequestContato result = contatoController.createContact(xml).getBody();
        assertEquals(resposta, result);
    }
    ...
    void testCreateContactException() {
        ...
        JsonRequestContato jsonRequest = new JsonRequestContato();
        RetornoRequestContato retornoRequest = new RetornoRequestContato();
...
//        contato.contato.setCnpj("00.000.000/0000-00");
        ...
        JsonRequestContato result = contatoController.updateContact(xml,cpf_cnpj).getBody();
        assertEquals(resposta, result);
    }
